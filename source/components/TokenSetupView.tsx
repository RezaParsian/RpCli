...
import openDeepSeek, { DEEPSEEK_TOKEN_COMMAND, DEEPSEEK_URL } from '../core/OpenDeepSeek.js'
...
export default function TokenSetupView({ onTokenSaved }: Props) {
	...
	const [status, setStatus] = useState<'input' | 'saving' | 'saved' | 'error'>('input')
	...
	return (
		<Box flexDirection="column">
			...
			<Text>1. Sign in to DeepSeek in the browser that was opened: {DEEPSEEK_URL}</Text>
