...
import { describeToolConfirmation, type ToolCall, type ToolConfirmationDetails } from '../tools/index.js'
...
export function ToolConfirmation({ details }: { details: ToolConfirmationDetails }) {
	return (
		<Box flexDirection="column" borderStyle="round" borderColor="yellow" paddingX={1}>
			...
			<Text>
				Proceed? <Text color="green">[y] yes</Text> <Text color="red">[n] no</Text>
			</Text>
		</Box>
	)
}
